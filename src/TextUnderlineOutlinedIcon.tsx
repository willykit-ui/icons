...
const svgChildren = {
  small: {
    content: {
      __html: `<path fill="currentColor" d="M9.5 10a.5.5 0 0 1 0 1h-7a.5.5 0 0 1 0-1zM2 5V1.5a.5.5 0 0 1 1 0V5c0 1.659 1.341 3 3 3s3-1.341 3-3V1.5a.5.5 0 0 1 1 0V5c0 2.211-1.789 4-4 4S2 7.211 2 5"/>`,
    },
    viewBox: "0 0 12 12",
  },
