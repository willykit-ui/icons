...
const svgChildren = {
  ...
  large: {
    content: {
      __html: `<path fillRule="evenodd" d="M9.575 1.683a.5.5 0 0 1 .85 0l2.818 4.533a.5.5 0 0 0 .305.222l5.182 1.28a.5.5 0 0 1 .262.807l-3.44 4.08a.5.5 0 0 0-.116.36l.384 5.323a.5.5 0 0 1-.687.5l-4.944-2.011a.5.5 0 0 0-.377 0l-4.945 2.01-.064.022a.5.5 0 0 1-.623-.52l.385-5.325a.5.5 0 0 0-.062-.278l-.055-.08-3.44-4.081a.5.5 0 0 1 .263-.808l5.181-1.28a.5.5 0 0 0 .305-.22zM7.607 6.745c-.207.331-.535.57-.914.664L2.29 8.495l2.923 3.467a1.5 1.5 0 0 1 .349 1.075l-.326 4.521 4.199-1.707.137-.049c.28-.083.577-.083.856 0l.138.049 4.198 1.707-.325-4.521a1.5 1.5 0 0 1 .348-1.075l2.922-3.467-4.401-1.086a1.5 1.5 0 0 1-.914-.664L10 2.894z" clipRule="evenodd" fill="currentColor"/>`,
    },
    viewBox: "0 0 20 20",
  },
};
