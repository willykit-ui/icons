...
const DangerCircleFilledIcon = React.forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      fontSize = "medium",
      color = "currentColor",
...
DangerCircleFilledIcon.displayName = "DangerCircleFilledIcon";

export default DangerCircleFilledIcon;
