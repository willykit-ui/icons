...
const svgChildren = {
  ...
  large: {
    content: {
      __html: `<path fillRule="evenodd" d="M14.742 12.003c.65.011 1.044.056 1.358.237l.1.063c.23.153.42.357.559.596l.08.165c.115.287.148.65.157 1.193l.004.742c0 1.121 0 1.682-.241 2.1a1.8 1.8 0 0 1-.66.659c-.313.18-.706.226-1.357.237L14 18c-1.121 0-1.682 0-2.1-.241a1.8 1.8 0 0 1-.659-.66C11.001 16.682 11 16.12 11 15s0-1.682.241-2.1l.063-.1c.153-.23.357-.42.596-.559l.165-.08C12.467 12 13.019 12 14 12zM14 13.099c-.581 0-.943.001-1.215.026-.254.023-.32.06-.335.067a.7.7 0 0 0-.257.257c-.008.014-.044.081-.067.335-.025.272-.026.634-.026 1.215s.001.943.026 1.215c.023.254.06.32.067.335.062.106.15.195.257.257.014.008.081.044.335.067.272.025.634.026 1.215.026s.943-.001 1.215-.026c.254-.023.32-.06.335-.067a.7.7 0 0 0 .257-.257c.008-.014.044-.081.067-.335.025-.272.026-.634.026-1.215s-.001-.943-.026-1.215c-.023-.254-.06-.32-.067-.335a.7.7 0 0 0-.257-.257c-.014-.008-.081-.044-.335-.067-.272-.025-.634-.026-1.215-.026" clipRule="evenodd" fill="currentColor"/><path d="M3.5 1.45a.55.55 0 0 1 .55.549v2.95H8.5a.55.55 0 0 1 0 1.1H4.05v6.45c0 .8.65 1.45 1.45 1.45h3.03a.55.55 0 0 1 0 1.1H5.5a2.55 2.55 0 0 1-2.55-2.55v-10.5a.55.55 0 0 1 .55-.55M14 2.45a.55.55 0 0 1 .55.549v1.95h1.95a.55.55 0 1 1 0 1.1h-1.95v1.95a.55.55 0 1 1-1.1 0v-1.95H11.5a.55.55 0 1 1 0-1.1h1.95V3a.55.55 0 0 1 .55-.55" fill="currentColor"/>`,
    },
    viewBox: "0 0 20 20",
  },
};
