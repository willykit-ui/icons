...
const svgChildren = {
  small: {
    content: {
      __html: `<path fill="currentColor" d="M8.059 6.059A.2.2 0 0 1 8 5.917V2.2c0-.11.09-.2.2-.2h.1a.2.2 0 0 0 .2-.2v-.6a.2.2 0 0 0-.2-.2H3.7a.2.2 0 0 0-.2.2v.6c0 .11.09.2.2.2h.1c.11 0 .2.09.2.2v3.717a.2.2 0 0 1-.059.142l-.882.882A.2.2 0 0 0 3 7.083V7.8c0 .11.09.2.2.2h2.1c.11 0 .2.09.2.2v2.6c0 .11.09.2.2.2h.6a.2.2 0 0 0 .2-.2V8.2c0-.11.09-.2.2-.2h2.1a.2.2 0 0 0 .2-.2v-.717a.2.2 0 0 0-.059-.142z"/>`,
    },
    viewBox: "0 0 12 12",
  },
