...
const svgChildren = {
  ...
  large: {
    content: {
      __html: `<path fillRule="evenodd" d="M5.416 10.75c.771 0 1.4-.001 1.895.065.51.069.951.217 1.304.57.352.352.5.793.57 1.303.066.494.065 1.124.065 1.895s0 1.4-.066 1.896c-.068.509-.217.95-.57 1.303-.352.353-.794.501-1.303.57-.495.066-1.124.065-1.895.065-.772 0-1.401.001-1.896-.065-.51-.069-.95-.218-1.303-.57-.352-.352-.5-.794-.57-1.303-.066-.495-.064-1.125-.064-1.896s-.002-1.4.065-1.896c.068-.509.217-.95.57-1.302.352-.353.793-.501 1.302-.57.495-.066 1.124-.065 1.896-.065m0 1c-.8 0-1.35.001-1.762.057-.399.053-.594.15-.73.285-.135.135-.231.33-.285.73-.055.412-.056.961-.056 1.761s0 1.35.056 1.763c.054.398.15.593.285.73.136.135.332.23.73.284.413.056.962.057 1.762.057s1.35-.001 1.762-.057c.399-.053.594-.15.73-.285.135-.136.231-.331.285-.73.055-.412.057-.962.057-1.762s-.002-1.349-.057-1.762c-.054-.398-.15-.594-.285-.73-.136-.135-.332-.23-.73-.284-.413-.056-.963-.057-1.762-.057m9.168-1a3.834 3.834 0 1 1-.001 7.669 3.834 3.834 0 0 1 0-7.669m0 1a2.833 2.833 0 1 0 0 5.667 2.833 2.833 0 0 0 0-5.667M5.416 1.582a3.834 3.834 0 1 1 0 7.668 3.834 3.834 0 0 1 0-7.668m0 1a2.833 2.833 0 1 0 0 5.667 2.833 2.833 0 0 0 0-5.667" clipRule="evenodd" fill="currentColor"/><path d="M14.583 2.418a.5.5 0 0 1 .5.5v2h2a.5.5 0 1 1 0 1h-2v2a.5.5 0 1 1-1 0v-2h-2a.5.5 0 0 1 0-1h2v-2a.5.5 0 0 1 .5-.5" fill="currentColor"/>`,
    },
    viewBox: "0 0 20 20",
  },
};
