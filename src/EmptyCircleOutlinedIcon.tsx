...
const EmptyCircleOutlinedIcon = React.forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      fontSize = "medium",
      color = "currentColor",
...
EmptyCircleOutlinedIcon.displayName = "EmptyCircleOutlinedIcon";

export default EmptyCircleOutlinedIcon;
