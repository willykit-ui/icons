...
const TextItalicOutlinedIcon = React.forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      fontSize = "medium",
      color = "currentColor",
...
TextItalicOutlinedIcon.displayName = "TextItalicOutlinedIcon";

export default TextItalicOutlinedIcon;
