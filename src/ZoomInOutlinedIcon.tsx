...
const svgChildren = {
  ...
  large: {
    content: {
      __html: `<path d="M9.42 5.598a.5.5 0 0 1 .5.5V8.72h2.626a.5.5 0 0 1 0 1H9.92v2.627a.5.5 0 0 1-1 0V9.72H6.296a.5.5 0 1 1 0-1H8.92V6.098a.5.5 0 0 1 .5-.5" fill="currentColor"/><path fillRule="evenodd" d="M9.42 1.8a7.421 7.421 0 0 1 5.545 12.351l3.444 3.211a.6.6 0 1 1-.817.878l-3.496-3.257A7.42 7.42 0 1 1 9.42 1.8m0 1.201a6.22 6.22 0 1 0 0 12.441 6.22 6.22 0 0 0 0-12.441" clipRule="evenodd" fill="currentColor"/>`,
    },
    viewBox: "0 0 20 20",
  },
};
