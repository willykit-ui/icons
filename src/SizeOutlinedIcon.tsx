...
/**
 * SizeOutlinedIcon icon component.
...
const SizeOutlinedIcon = React.forwardRef<SVGSVGElement, IconProps>(
  (props, ref) => {
    const {
      fontSize = "medium",
      color = "currentColor",
...
SizeOutlinedIcon.displayName = "SizeOutlinedIcon";

export default SizeOutlinedIcon;
